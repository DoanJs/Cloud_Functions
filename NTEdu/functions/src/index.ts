          ...
          [
            {
              ...
              url: `https://can-thiep-som-nha-trang.vercel.app/${route}`,
            },
          ],
        ],
      },
...
function formatPending(title: string, items: any[]) {
  ...
  text += shownItems
    .map(
      (p, i) =>
        `<a href="https://can-thiep-som-nha-trang.vercel.app/home/${p.childId}/pending">` +
...
export const weeklyBackupFirestoreToTelegram = onSchedule(
  ...
  async () => {
    ...
    const filename = `firestore_backup_NTEdu_${dateText}.js`;
